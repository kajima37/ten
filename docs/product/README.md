...
- 成功時だけ光と短い振動を使い、達成感を強調する。効果音は今後追加する
...
- スコア、コンボ、ヒント、シャッフル、＋10秒、一時停止
- 落下する数字だけが動く盤面アニメーションと、操作方向を考慮したセル選択
- ベストスコア、プレイ回数、履歴、実績、ストリークの端末内保存
- 日英表示、6種類のテーマ、振動、動きを減らす設定
...
- 効果音と音量設定、FEVERなどの高コンボ演出
- 3分モード、時間制限なしモード
- PWAとしてのインストールとオフライン起動
- 広告、動画広告報酬、広告削除課金、テーマ購入管理
- App Store / Google Play向けの正式な署名・審査・配布

## 11. 正式版に向けた優先事項

1. ゲームルール、得点バランス、盤面生成の継続的な検証
2. PWA対応と主要画面のE2Eテスト
3. 成功時の効果音、音量設定、FEVER演出
4. 3分モードと時間制限なしモード
5. アクセシビリティ、実機差、低速・切断時の動作確認
6. 運用環境のCloudflare Worker、D1、KV、シークレット設定
7. 広告、広告削除課金、テーマ販売
8. iOS・Androidの署名、ストア公開素材、審査対応
