...
function legalLayout(
  ...
  content = `<style>.legal-card{position:relative}.header-link{visibility:hidden}.language-switch{position:absolute;top:-48px;right:0;font-size:.7rem}.language-switch a{margin-left:10px;color:var(--muted);text-decoration:none}.language-switch a:hover{color:var(--accent)}.legal-nav{position:absolute;top:100%;left:0;width:100%;margin-top:24px;border-top:0;padding-top:0}.legal-nav .language-nav{display:none}</style><nav class="language-switch" aria-label="${labels[4]}"><a href="?lang=ja">日本語</a><a href="?lang=en">English</a></nav>${content}`
...
function englishPrivacyPage(env: Env): Response {
  ...
  return legalLayout(
    'Privacy policy',
    `<h1>Privacy policy</h1><p>Last updated: September 4, 2026</p><p>TEN. is provided by ${developer}.</p><section><h2>Information we collect</h2><p>We collect a player ID, display name, device identifier, scores, play results, friend codes, and friend relationships to provide game features and leaderboards and to prevent abuse. Source IP addresses are hashed and used for abuse prevention.</p></section><section><h2>Advertising</h2><p>TEN. uses Google AdMob. Information handled by the advertising SDK is governed by Google's current policies and settings.</p></section><section><h2>Storage and sharing</h2><p>Server data is retained for as long as needed to provide the service. We do not sell personal information. Data is encrypted in transit.</p></section><section><h2>Deletion</h2><p>You can delete your account from My Page. If you cannot use the app, use the <a href="/account-deletion?lang=en">account deletion page</a>. Player, score, and social data are deleted.</p></section><section><h2>Contact</h2><p><a href="mailto:${email}">${email}</a></p></section>`,
    env,
    'en',
  )
}
